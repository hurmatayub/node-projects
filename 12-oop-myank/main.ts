...
const customers: Customer[] = [
    new Customer ("Hurmat", "Ayub", "Female", 19, 3191234567, accounts[0]),
    new Customer ("Iqra", "Muzammil", "Female", 20, 3193456865, accounts[1]),
    new Customer ("Hina", "Singh", "Female", 22, 3161234567, accounts[2])
]
